        ...
        for (i = 0; i < chars.length; i++) {
            switch (chars[i]) {
                ...
                case '[':
                    ...
                    break;
			/*
			 * case "Ã©": toReturn+="dc"; break; case ']': toReturn+="5d";
			 * break; case "Ã­": toReturn+="5e"; break; case "Ã³":
			 * toReturn+="df"; break; case "Ãº": toReturn+="e0"; break;
			 */
                case 'a':
                    toReturn += "61";
                    break;
                ...
                case 'z':
                    toReturn += "7a";
                    break;/*
					 * case "Ã§": toReturn+="fb"; break; case "Ã·":
					 * toReturn+="7c"; break; case "Ã": toReturn+="fd"; break;
					 * case "Ã±": toReturn+="fe"; break;
					 */
                case '|':
                    toReturn += "7f";
                    break;
